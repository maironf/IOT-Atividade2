...
var config_line2 = {
  ...
  options: {
    ...
    title: {
      display: true,
      text: 'Temperatura no Departamento de Matemáticas'
    },
    tooltips: {
      mode: 'index',
      intersect: false,
...
function getLastThingSpeakData(){
  ...
  var channel_id = 77468; //id do canal
  ...
  $.getJSON('https://api.thingspeak.com/channels/' + channel_id + '/fields/' + field_number1 + '.json?results=20', function(data) {
    // get the data point
    feeds = data.feeds;
